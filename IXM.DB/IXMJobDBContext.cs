...
namespace IXM.DB
{
    public class IXMJobDBContext : DbContext
    {
        ...
        public IXMJobDBContext(IConfiguration configuration, DbContextOptions<IXMJobDBContext> options)
        : base(options)
        ...
        public DbSet<PROCESS_RUN> PROCESS_RUN { get; set; }
        public DbSet<MPROCESSTASK> MPROCESSTASK { get; set; }
        public DbSet<TPROCESSTASK> TPROCESSTASK { get; set; }
        public DbSet<TJOBLOG> TJOBLOG { get; set; }
        ...
        {
            modelBuilder.Entity<TPROCESSTASK>().HasKey(r => new { r.PROCESSID, r.PARAMOBJ, r.PARAMFLD, r.PARAMVAL });
